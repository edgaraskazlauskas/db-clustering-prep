...
module.exports = class EntityRelationship {
  ...
  calculateStrength() {
    ...
    strength.apply(new ParentOnlyChildReward());
    strength.apply(new RelationshipPresenceReward());
    strength.apply(new NewbornOfSingleParentReward());
    strength.apply(new ParentIsAHubPenalty());
